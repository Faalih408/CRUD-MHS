...
<head>
    ...
    <title>PHP Native | CRUD Mahasiswa</title>
</head>
...
<body>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($mahasiswa as $row) : ?>
                            <tr>
                                ...
                                <td><?= $row['email']; ?></td>
                                <td>
                                    <button class="btn btn-success btn-sm text-white" data-id="<?= $row['NIM']; ?>" style="font-weight: 600;">|

                                    <a href="ubah.php?NIM=<?= $row['NIM']; ?>" class="btn btn-warning btn-sm" style="font-weight: 600;"><i class="bi bi-pencil-square"></i>&nbsp;Ubah</a> |

                                    <a href="hapus.php?NIM=<?= $row['NIM']; ?>" class="btn btn-danger btn-sm" style="font-weight: 600;" onclick="return confirm('Apakah anda yakin ingin menghapus data <?= $row['NamaMhs']; ?> ?');"><i class="bi bi-trash-fill"></i>&nbsp;Hapus</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
    ...
    <div class="container-fluid">
        <div class="row bg-dark text-white">
            <div class="col-md-6 my-2" id="about">
                ...
                <p>Menyelesaikan Tugas MataKuliah PBO tentang CRUD Mahasiswa</p>
            </div>
    ...
    <footer class="bg-dark text-white text-center" style="padding: 5px;">
        <p>Created with <i class="bi bi-suit-heart-fill" style="color: red;"></i> by <u style="color: #fff;">Faalih Hibban</u></p>
    </footer>
    <!-- Close Footer -->
