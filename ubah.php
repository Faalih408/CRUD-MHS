...
// Mengambil data dari table mahasiswa$mahasiswa dari NIM yang tidak sama dengan 0
            ...
            <div class="col-md">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control w-50" id="ID" value="<?= $mahasiswa['ID']; ?>" name="ID" readonly>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control w-50" id="NamaMhs" value="<?= $mahasiswa['NamaMhs']; ?>" name="NamaMhs" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control w-50" id="Kota" rows="5" name="Kota" autocomplete="off"><?= $mahasiswa['Kota']; ?></textarea>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <img src="img/<?= $mahasiswa['Foto']; ?>" width="50%" style="margin-bottom: 10px;">
